  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="http://chromedriver.storage.googleapis.com/index.html?path=2.34/">2.34</a>&nbsp;&nbsp;</td>
        <td><a href="http://chromedriver.storage.googleapis.com/2.34/notes.txt">change log</a>&nbsp;&nbsp;</td>
